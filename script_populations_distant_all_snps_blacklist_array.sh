...
#$ -cwd
#$ -j y
#$ -N job_populations_distant_all_snps_blacklist
...
populations \
   ...
   -O populations_distant_${SGE_TASK_ID}_all_snps_blacklist_output \
   -M /data/scratch/mpx469/tGBS_enset_project/gstacks/popmap_distant.txt \
   -R 0.8 \
   --min-mac 3 \
   -B /data/scratch/mpx469/tGBS_enset_project/blacklists/blacklist_overall_distant_${SGE_TASK_ID}_all_snps \
