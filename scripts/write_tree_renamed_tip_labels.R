...
# tree
tre <- read.tree("/data/scratch/mpx469/tGBS_enset_project/raxml_ng/raxml_ng_80_single_snp/best.tre.tbe.raxml.support.rooted.newick")
...
# write tree
write.tree(tre, "raxml.renamed.newick")
