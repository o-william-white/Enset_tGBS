...
mkdir -p populations_${SGE_TASK_ID}_all_snps_blacklist_output
...
populations \
   ...
   -R 0.8 \
   --min-mac 3 \
   -B /data/scratch/mpx469/tGBS_enset_project/blacklists/blacklists_overall/blacklist_${SGE_TASK_ID}_all_snps.txt \
   --phylip --phylip-var --phylip-var-all --vcf --fasta-loci --plink --radpainter --ordered-export
