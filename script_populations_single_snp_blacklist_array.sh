...
#$ -cwd
#$ -j y
#$ -N job_populations_single_snp_blacklist
...
populations \
   ...
   -O populations_${SGE_TASK_ID}_single_snp_blacklist_output \
   -M /data/scratch/mpx469/tGBS_enset_project/gstacks/popmap.txt \
   -R 0.8 \
   --min-mac 3 \
   -B /data/scratch/mpx469/tGBS_enset_project/blacklists/blacklist_overall_${SGE_TASK_ID}_single_snp \
   --write-single-snp \
