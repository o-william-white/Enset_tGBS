...
POPULATIONS_PATH="/data/scratch/mpx469/STACKS/populations/populations-together-all-snps-r80-default-1/"
OUTPUT_PATH="blacklist-together-all-snps-r80-default"
