...
POPULATIONS_PATH="/data/scratch/mpx469/STACKS/populations/populations-separate-all-snps-R80-maf-het-1/"
OUTPUT_PATH="blacklist-separate-all-snps-R80-maf-het"
