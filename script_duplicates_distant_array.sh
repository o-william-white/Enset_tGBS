...
#$ -cwd
#$ -j y
#$ -N job_duplicates_distant_array
#$ -t 1-12
...
POPULATIONS_PATH="/data/scratch/mpx469/tGBS_enset_project/populations/populations_distant_${LENGTH}_${DATASET}_output/"
OUTPUT_PATH="duplicates_distant_${LENGTH}_${DATASET}_output"
...
# write blacklist
cut -f 4 ${OUTPUT_PATH}/duplicates_loci | sort | uniq > blacklist_duplicates_distant_${LENGTH}_${DATASET}

# number of loci in blacklist
BLACKLIST=`wc -l blacklist_duplicates_distant_${LENGTH}_${DATASET} | cut -f 1 -d " "`
