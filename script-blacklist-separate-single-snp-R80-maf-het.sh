...
POPULATIONS_PATH="/data/scratch/mpx469/STACKS/populations/populations-separate-single-snp-R80-maf-het-1/"
OUTPUT_PATH="blacklist-separate-single-snp-R80-maf-het"
